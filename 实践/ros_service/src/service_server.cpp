...
bool calculation(ros_service::ServiceTest::Request &req,
                 ros_service::ServiceTest::Response &res)
{
...
int main(int argc, char **argv) // 节点主函数
{
    ...
    */
    ros::init(argc, argv, "service_server"); // 解析参数，命名节点
    ...
    */
    // 声明服务服务器，创建使用ros_service功能包中的ServiceTest.srv服务文件的 服务服务器ros_service_server。服务名称是"ros_service_srv" ，
    // 第二个参数注册 回调函数calculation。此服务器当收到服务请求时，会执行calculation()。
    ros::ServiceServer ros_service_server = nh.advertiseService("ros_service_srv", calculation);
    /*
